...
public class Constants {
	...
	public static final float NOT_IN_TERMS = -5;
	public static final float HAS_NOT_WEIGHT = -1;

	public static final boolean KNOWLEDGE_BASE_SPECIALIZATION_DIRECTION = false;
	public static final boolean KNOWLEDGE_BASE_GENERALIZATION_DIRECTION = true;
